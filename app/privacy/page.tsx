  ...
  return (
    <div className="min-h-screen py-20 px-6" style={{ backgroundColor: "#000D0F" }}>
      <div className="mx-auto max-w-3xl">
        <h1 className="text-3xl font-light mb-2" style={{ color: "#FFFFFF" }}>Privacy Policy</h1>
        ...
        <div className="space-y-10 text-sm leading-relaxed" style={{ color: "#8A8D8F" }}>
          ...
          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>1. Who we are</h2>
            ...
            <p className="mt-2">Contact: <a href="mailto:support@trovar.co.nz" style={{ color: "#B6FF3B" }}>support@trovar.co.nz</a></p>
          </section>

          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>2. What data we collect</h2>
            <p>We collect the following data when you use Trovar:</p>
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li><strong style={{ color: "#FFFFFF" }}>Account data:</strong> Your name, email address, and accounting practice name when you sign up.</li>
              <li><strong style={{ color: "#FFFFFF" }}>Client data:</strong> Names and email addresses of clients you add to your practice account.</li>
              <li><strong style={{ color: "#FFFFFF" }}>OAuth tokens:</strong> Access tokens from connected platforms (Meta Ads, Google Ads, Adobe, Shopify) used solely to retrieve billing invoices on your behalf. We do not store passwords.</li>
              <li><strong style={{ color: "#FFFFFF" }}>Invoice data:</strong> Billing invoices retrieved from connected platforms including invoice ID, date, amount, currency, and description.</li>
              <li><strong style={{ color: "#FFFFFF" }}>Usage data:</strong> Basic usage information such as login times and feature usage to improve the product.</li>
            </ul>
          </section>

          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>3. How we use your data</h2>
            <ul className="mt-3 space-y-2 list-disc list-inside">
          ...
          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>4. Meta Platform data</h2>
            <p>When you connect a client's Meta Ads account, Trovar requests the following permissions:</p>
            <ul className="mt-3 space-y-2 list-disc list-inside">
              <li><strong style={{ color: "#FFFFFF" }}>ads_read:</strong> To retrieve billing invoices and ad account information</li>
              <li><strong style={{ color: "#FFFFFF" }}>business_management:</strong> To access business-level invoice data</li>
            </ul>
          ...
          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>5. Data storage and security</h2>
          ...
          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>6. Data retention</h2>
          ...
          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>7. Your rights</h2>
            ...
            <p className="mt-3">To exercise these rights, email <a href="mailto:support@trovar.co.nz" style={{ color: "#B6FF3B" }}>support@trovar.co.nz</a>.</p>
          </section>

          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>8. Cookies</h2>
          ...
          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>9. Changes to this policy</h2>
          ...
          <section>
            <h2 className="text-base font-medium mb-3" style={{ color: "#FFFFFF" }}>10. Contact</h2>
            <p>For any privacy questions or concerns: <a href="mailto:support@trovar.co.nz" style={{ color: "#B6FF3B" }}>support@trovar.co.nz</a></p>
          </section>
